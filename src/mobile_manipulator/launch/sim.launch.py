...
def generate_launch_description():
 ...
 spawners=[Node(package='controller_manager',executable='spawner',arguments=[c]) for c in ['joint_state_broadcaster','base_controller','arm_controller']]
 nodes=[spawn,bridge,Node(package='mobile_manipulator',executable='ball_detector'),Node(package='mobile_manipulator',executable='visual_tracker')]
 return LaunchDescription([gz,expand,rsp,TimerAction(period=5.0,actions=nodes),TimerAction(period=9.0,actions=spawners)])
